...
<img src="lol.png" style="width:90%">
![](ee45b2981888bc8d7003d4bcb43f3ee1.png)
...
embed_url("https://www.youtube.com/watch?v=q3D5-t2vo64")
```

# Motivation

All of our team members love League of Legends so much and this game has become an integral part of our lives. We really enjoy winning the game, but we are not always win. We know the taste of failure very well. So we are very curious about the deteminants of winning the game, other than those unmeasurable data like personal skills and cooperation.
...
Killing is a very important player behavior in League of Legends games. To be more specific, killing can be interpreted as your controlled player, called champion in this game, kills enemy's champion or is killed by enemy's. It just like the Pokémon you used in the Pokémon game, which is defeated by the opponent's Pokémon. Killing has a huge potential impact on the progress of the game. On the one hand, killing behavior brings money to your team, so that you have more money to buy powerful equipments and make your champions stronger. On the other hand, enemy's killed champions enters resurrection time and they will not be able to act during resurrection time.
...
There are many neutral monsters located in different spots in the game. After killing certain monsters, you will get both monetary rewards and additional special effect gains, called buff in the game. Dragon (with 5 different types), Rift Herald and Baron Nashor are the three of the most important monsters.

* **Golds**

Gold is the name of money in the game. It enables players to buy powerful equipments for champions they controlled. There are many ways to earn Gold in the game, such as killing, taking down towers and killing netural monsters. A gold lead will give your team a huge game advantage, which will drive your team to victory.

# Methods

We conducted [exploratory data analysis](visualization.html) to describe the relationship between the blue team's game result and the four main predictors. In order to visualize their relationships, we constructed several graphs to seek the potential associations. Statistical analysis was performed, specifically the exploration of the correlation between the four covariates. Furthermore, we employed [logistic regression](model.html) to model the effect of the four main predictors on the blue team's game result. Interaction terms were introduced based on findings on correaltions. The relative effect (odds ratio) was measured and was further applied in our tool for [blue team win rate prediction](https://xing1215.shinyapps.io/shiny/#section-winning-rate-simulator).

# Results

By using the League of Legends Competitive Matches data, we were able to inspect factors which affect the result of a single League of Legends game and their influence on the result. By employing the exploratory data analysis as well as statistical analysis, we found that more kills, less towers-taking-down time, slaying monsters and more golds increase the chance of winning for the blue team, even though the predictor representing taking down towers' time was non-significant in our logistic model. But this could be explained from other perspective and we did suggested an alternative reason in the statistical analysis section. Furthermore, the correlation between covariates showed that all the variables were more or less related to the number of golds.