...
merge_file %>% 
  ...
  geom_boxplot() +
  labs(
    title = "Fig2: total golds difference vs. battle results",
    x = "results of blue team", 
...
merge_file %>% 
  ...
  coord_flip() + 
  labs(
    title = "Fig3: numbers of killing neutral monsters vs. battle results",
    x = "numbers of kills",
    y = "type of neutral monsters"
  )
```
...
=======
merge_file <- left_join(merge_file,kills,by = "address")
>>>>>>> 8e1e2b71cd779937deb16f919930cd14aa97f199
## relevel b_results
...
=======
  geom_boxplot() +
  labs(
    title = "Fig4: the mean killing difference vs. battle result",
    x = "results of blue team",
