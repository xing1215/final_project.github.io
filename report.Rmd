...
* **Towers**
Data of towers are nested in `_columns.csv` file. This file records the information about unique match id, team id, tower id and the time in the game for each tower being taken down.
...
Amongst two of the interaction terms, the interaction bewteen `golddiff_mean` and `BARON_NASHOR` was significant while the interaction bewteen `golddiff_mean` and `kill_diff` was not. One thing needed to be noted here was that the coefficient of the interaction bewteen `golddiff_mean` and `BARON_NASHOR` was negative. This indicated that if blue team had both gold lead and had taken down baron nashor, the two things togther made the increament in the odds of winning by blue team less.
